...
// HarmonyOS NAPI 库使用 NDK hilog API
// Note: Use explicit ::LogLevel:: prefix to avoid conflicts with Hdc::LOG_* constants
#ifdef HDC_NAPI_LIBRARY
#include <hilog/log.h>
// OH_LOG_* macros use LOG_INFO etc. which conflicts with Hdc::LOG_INFO
// We need to call OH_LOG_Print directly with explicit ::LogLevel enum
#define HDC_LOG_DEBUG(...) ((void)OH_LOG_Print(LOG_APP, ::LogLevel::LOG_DEBUG, LOG_DOMAIN, LOG_TAG, __VA_ARGS__))
#define HDC_LOG_INFO(...) ((void)OH_LOG_Print(LOG_APP, ::LogLevel::LOG_INFO, LOG_DOMAIN, LOG_TAG, __VA_ARGS__))
#define HDC_LOG_WARN(...) ((void)OH_LOG_Print(LOG_APP, ::LogLevel::LOG_WARN, LOG_DOMAIN, LOG_TAG, __VA_ARGS__))
#define HDC_LOG_ERROR(...) ((void)OH_LOG_Print(LOG_APP, ::LogLevel::LOG_ERROR, LOG_DOMAIN, LOG_TAG, __VA_ARGS__))
#define HDC_LOG_FATAL(...) ((void)OH_LOG_Print(LOG_APP, ::LogLevel::LOG_FATAL, LOG_DOMAIN, LOG_TAG, __VA_ARGS__))
#else
// OpenHarmony 系统使用 HILOG_IMPL
...
#if defined(HOST_OHOS) || defined(__OHOS__)
